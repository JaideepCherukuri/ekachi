export default {
  ...
  'Friday': '周五',
  'Saturday': '周六',
  'Manus Computer': 'Ekachi 的电脑',
  'Manus is using': 'Ekachi 正在使用',
  'Jump to live': '跳到实时',
  'Failed to load file content': '加载文件内容失败',
  'Give Manus a task to work on...': '给 Ekachi 一个任务...',
  // Shell tools
  ...
  'Archive': '压缩包',
  // Login/Register Page
  'Login to Ekachi': '登录 Ekachi',
  'Register to Ekachi': '注册 Ekachi',
  'Full Name': '姓名',
  'Email': '邮箱',
  'Password': '密码',
  ...
  'Registration successful! Welcome to Ekachi': '注册成功！欢迎使用 Ekachi',
  ...
  'You are viewing a completed Ekachi task. Replay will start automatically in {countdown} seconds.': '您正在查看一个已完成的 Ekachi 任务。回放将在 {countdown} 秒后自动开始。',
  // Claw Page
  ...
  'Chat Freely via Ekachi': '通过 Ekachi 自由对话',
  ...
  'Get Started': '立即开始',
  'Create Ekachi Claw': '创建 Ekachi Claw',
  'One-click OpenClaw deployment by Ekachi': 'Ekachi 帮你一键部署的 OpenClaw',
  'Creating...': '创建中...',
  'Create': '创建',
