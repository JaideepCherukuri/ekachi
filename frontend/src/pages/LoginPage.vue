<template>
  <div class="w-full min-h-[100vh] relative bg-[var(--background-gray-main)] dark:bg-[#050505]">
    <div class="sticky top-0 left-0 w-full z-[10] px-3 sm:px-6 md:px-12 max-sm:bg-[var(--background-gray-login)]">
    ...
    <div
      ...
      <div class="w-full max-w-[720px] pt-[24px] mb-[40px] max-sm:pt-[0px] px-3 sm:px-0">
        <div class="flex flex-col items-center gap-[20px] relative" style="z-index:1">
          ...
          <h1 class="text-[20px] font-bold text-center text-[var(--text-primary)] max-sm:text-[18px]">
            {{ 
              ...
              : isRegistering ? t('Register to Ekachi') 
              : t('Login to Ekachi') 
            }}
          </h1>
        </div>
