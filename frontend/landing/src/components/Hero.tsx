...
export default function Hero() {
	...
	return (
		<section
			className="pt-24 md:pt-36 pb-16 md:pb-24 px-6 relative overflow-hidden"
			...
			<div className="max-w-7xl mx-auto" style={{ position: "relative", zIndex: 1 }}>
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 xl:gap-20 items-start">
					<div>
						...
						<div className="hidden md:block border border-[#E5E2DC] rounded-2xl overflow-hidden mt-3 md:mt-9">
							{tabs.map((tab, i) => (
								<button
									key={tab.key}
