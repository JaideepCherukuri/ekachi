export default {
  ...
  'Friday': 'Fri',
  'Saturday': 'Sat',
  'Manus Computer': 'Ekachi Computer',
  'Manus is using': 'Ekachi is using',
  'Jump to live': 'Jump to live',
  'Failed to load file content': 'Failed to load file content',
  'Give Manus a task to work on...': 'Give Ekachi a task to work on...',
  // Shell tools
  ...
  'Archive': 'Archive',
  // Login/Register Page
  'Login to Ekachi': 'Login to Ekachi',
  'Register to Ekachi': 'Register to Ekachi',
  'Full Name': 'Full Name',
  'Email': 'Email',
  'Password': 'Password',
  ...
  'Registration successful! Welcome to Ekachi': 'Registration successful! Welcome to Ekachi',
  ...
  'You are viewing a completed Ekachi task. Replay will start automatically in {countdown} seconds.': 'You are viewing a completed Ekachi task. Replay will start automatically in {countdown} seconds.',
  // Claw Page
  ...
  'Chat Freely via Ekachi': 'Chat Freely via Ekachi',
  ...
  'Create Ekachi Claw': 'Create Ekachi Claw',
  'One-click OpenClaw deployment by Ekachi': 'One-click OpenClaw deployment by Ekachi',
  'Creating...': 'Creating...',
  'Create': 'Create',
