...
const bentoItems = [
	{
		...
		desc: 'Ekachi reads your documentation, Slack history, code, and meeting notes before they start. No two-week ramp. No "can you explain the context?"',
		bg: "/bg-feature-1.jpg",
		reversed: false,
	...
	},
	{
		...
		desc: "Ekachi doesn't wait for a prompt. They monitor what's happening, identify what matters, and surface it. A draft is already attached.",
		bg: "/bg-feature-2.jpg",
		reversed: true,
		Visual: SlackVisual,
	},
	{
		...
		desc: "Ekachi remembers context from three months ago, decisions made in side channels, commitments others forgot. The kind of institutional memory that usually gets lost between handoffs, threads, and time zones.",
		bg: "/bg-feature-3.jpg",
		reversed: false,
	...
	},
	{
		...
		desc: "Ekachi attends calls, takes real-time notes, captures action items, and sends follow-ups. Without being asked. Without missing anything.",
		bg: "/bg-feature-4.jpg",
		reversed: true,
	...
	return (
		<section className="py-12 md:py-24 px-6 border-t border-[#E5E2DC]">
			<div className="max-w-7xl mx-auto">
				<p className="text-[#A8A49E] text-xs tracking-widest uppercase mb-4">What Ekachi does</p>
				<h2
